    ...
    <div>
        <nav class="t-header">
            <div class="t-header-brand-wrapper">
                <a href="index.html">
                    <img class="logo" src="/asset/images/smatrimurti.png" alt="" >
                    <img class="logo-mini" src="/asset/images/trimurti.gif" alt="">
                </a>
            </div>
                                ...
                                <div class="dropdown-body">
                                    ...
                                    <div class="dropdown-list">
                                        ...
                                        <div class="content-wrapper">
                                            ...
                                            <small class="content-text">Please verify your password to continue using
